...
class MOTCAT_Surv(nn.Module):
    ...
    def forward(self, **kwargs):
        ...
        ### Coattn
        #print(f"h_path_bag: {h_path_bag.shape}")
        #print(f"h_omic_bag: {h_omic_bag.shape}")
        A_coattn, _ = self.coattn(h_path_bag, h_omic_bag)
        #print(f"A_coattn: {A_coattn.shape}") #1*1*6*micro_batch
        #print(f"h_path_bag: {h_path_bag.shape}") #micro_batch*1*f_dim
        ...
        #print(f"A_coattn: {A_coattn.shape}")
        #print(f"h_path_bag: {h_path_bag.shape}") #1*1*6*micro_batch
        h_path_coattn = torch.mm(A_coattn, h_path_bag).unsqueeze(1)
        #print(f"h_path_coattn: {h_path_coattn.shape}")
        ### Path
        ...
        #print(f"h_path: {h_path.shape}") #256*,
        ### Omic
        ...
        #print(f"h_omic: {h_omic.shape}") #256*,
